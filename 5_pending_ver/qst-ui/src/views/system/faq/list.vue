...
<!--      <el-form-item label="贷款积分" prop="loaIntegral">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        ...
        size="mini"
        :disabled="multiple"
        @click="handleDelete">撤回申请</el-button>
      </el-col>
  ...
  methods: {
    ...
    getCId(){
      getComId(this.getUsername()).then(response=>{
        this.queryParams.loaComNo = response.comId; 
        console.log(this.queryParams.loaComNo)
      })
    },
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认撤回贷款编号为"' + loaIds + '"的数据项?', "警告", {
